...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Heyoo mass😆", "Aku ada pertanyaan buat kamu", "question").then(function () {
                ...
                Swal.fire({
                  ...
                  Swal.fire(`Makasih ya udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      showDenyButton: true,
                      showCancelButton: false,
                      confirmButtonText: `Seneng`,
                      denyButtonText: `Engga tu`,
                    }).then((result) => {
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Aaaa iyaa ${sender} juga seneng banget ketemu ${nama} , makasihhh yaa lofyu`).then(function () {
                          Swal.fire('Terakhir deh nii').then(function () {
                            Swal.fire('Coba klik ikon hati di paling bawah dong')
                          })
                        })
                      } else if (result.isDenied) {
                        Swal.fire('Yahhh, jahat banget sedih :(', '', 'error').then(function () {
                          Swal.fire('Yaudah deh okee mass:((')
                        })
                      }
                    })
                  })
